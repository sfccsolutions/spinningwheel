...
jquery__WEBPACK_IMPORTED_MODULE_0__("#btn-decline").hide();
jquery__WEBPACK_IMPORTED_MODULE_0__("#walletIcon").hide();
//import $ from 'jquery' ;
...
var dataValue = jquery__WEBPACK_IMPORTED_MODULE_0__('#mySpinerData').val();
var spinOptions = jquery__WEBPACK_IMPORTED_MODULE_0__('#mySpinerOptions').val();
console.log("anber");
...
if (spinOptions === "Points") {
    jquery__WEBPACK_IMPORTED_MODULE_0__("#walletIcon").show();
...
function spin(d) {
        updateSpinCount().then(
            function (value) {
                ...
                var enable = jquery__WEBPACK_IMPORTED_MODULE_0__('#enableSpinningWheel').val();
                console.log(enable);
                // if(enable === "false"){
                //     $("#question h1")
                ...
                var spin_wheel_duration = jquery__WEBPACK_IMPORTED_MODULE_0__('#spinWheelDuration').val();
...
function addSpinnerPoints(points) {
    ...
    var walletUrl = jquery__WEBPACK_IMPORTED_MODULE_0__('#walletUrl').val();
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__["ajax"]({
        ...
        success: function (data) {
            ...
            console.log(data);
            if (data.success) {
                jquery__WEBPACK_IMPORTED_MODULE_0__("#walletIcon")
                    .html(`<span class='fa fa-database ' id="coins" title="Points" aria-hidden="true"></span>
                    ${data.rewards}`)
                jquery__WEBPACK_IMPORTED_MODULE_0__("#loyaltyPointsIcon").html(`${data.earned_dollar}`);
...
async function updateSpinCount() {
    ...
    var updateSpinCountUrl = jquery__WEBPACK_IMPORTED_MODULE_0__('#updateSpinCountUrl').val();
